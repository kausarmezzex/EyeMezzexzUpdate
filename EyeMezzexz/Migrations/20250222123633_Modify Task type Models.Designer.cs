...
namespace EyeMezzexz.Migrations
{
    ...
    [Migration("20250222123633_Modify Task type Models")]
    partial class ModifyTasktypeModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EyeMezzexz.Models.ComputerCategory", b =>
                {
                    ...
                    b.HasKey("ComputerId", "CategoryId");

                    b.ToTable("ComputerCategories");
                });

            modelBuilder.Entity("EyeMezzexz.Models.ComputerWiseTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EyeMezzexz.Models.OfficeLeave", b =>
                {
                    ...
                    b.Property<string>("LeavePaymentType")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("StatusChangeOn")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("EyeMezzexz.Models.RotaDetail", b =>
                {
            ...
            modelBuilder.Entity("EyeMezzexz.Models.TaskUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EyeMezzexz.Models.UserAccountDetail", b =>
                {
                    ...
                    b.Property<int?>("CarryOverLeave")
                        .HasColumnType("int");

                    b.Property<int?>("CarryOverLeaveHours")
                        .HasColumnType("int");

                    b.Property<int?>("CashHours")
                        .HasColumnType("int");

                    b.Property<decimal?>("CashHoursRate")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("PayBackTo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("PayrollHours")
                        .HasColumnType("int");

                    b.Property<decimal?>("PayrollHoursRate")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("PayrollNumber")
                        .HasColumnType("int");

                    b.Property<int?>("RemainingYearlyHours")
                        .HasColumnType("int");

                    b.Property<int?>("RemainingYearlyLeave")
                        .HasColumnType("int");

                    b.Property<int>("UserId")
                        .HasColumnType("int");

                    b.Property<int?>("YearlyLeave")
                        .HasColumnType("int");

                    b.Property<int?>("YearlyLeaveHours")
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserAccountDetail");
                });

            modelBuilder.Entity("EyeMezzexz.Models.UserComputer", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EyeMezzexz.Models.UserLog", b =>
                {
            ...
            modelBuilder.Entity("EyeMezzexz.Models.RotaDetail", b =>
                {
                    b.HasOne("EyeMezzexz.Models.Shift", "AssignedShift")
                        .WithMany()
            ...
            modelBuilder.Entity("EyeMezzexz.Models.UserAccountDetail", b =>
                {
                    b.HasOne("EyeMezzexz.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EyeMezzexz.Models.Computer", b =>
                {
                    b.Navigation("ComputerCategories");
