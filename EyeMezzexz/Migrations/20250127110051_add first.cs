        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentNames = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Documents = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifyOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifyBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RemainingHolidayDays = table.Column<int>(type: "int", nullable: true),
                    RemainingHolidayHours = table.Column<int>(type: "int", nullable: true),
                    CarryOverDays = table.Column<int>(type: "int", nullable: true),
                    CarryOverHours = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusChnageBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StatusChnageOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AdminComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PaidLeaveDays = table.Column<int>(type: "int", nullable: true),
                    PaidLeaveHours = table.Column<int>(type: "int", nullable: true),
                    LeaveCreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LeaveForDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfficeLeaves", x => x.LeaveId);
                    table.ForeignKey(
                        name: "FK_OfficeLeaves_UserAccountDetails_UserId",
                        column: x => x.UserId,
                        principalTable: "UserAccountDetails",
